#!/usr/bin/env python3
"""humanize.detect — 纯 Python AI 味检测器

综合 6 个开源去 AI 味项目的规则, 给文本打 0-100 分:
- 0-24  LOW       基本像人写的
...
使用:
    from humanize.detect import score
    s = score("一段文本...")
    print(s.total, s.violations)

CLI:
    python -m humanize.detect <file>
"""
